            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3" class="pl-5">
                  ...
                  <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $koordinator->user->name }}">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3" class="pl-5">
                  ...
                  <br>
                  <select id="id_mku" name="id_mku" class="form-control @error('id_mku') is-invalid @enderror" value="{{ $koordinator->mku->nama }}">
                    <option value="{{ $koordinator->mku->id }}">{{ $koordinator->mku->nama }}</option>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3" class="pl-5">
                  ...
                  <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ $koordinator->no_hp}}">
