...
@section('title', 'konfirmasi lecturer')
      ...
      <form class="pl-5">
        ...
        <div class="container-fluid">
            ...
            <div class="mb-3" class="pl-5">
                <label for="prodi_id" class="form-label">Nama Program Studi</label> 
                <input type="text" name="prodi_id" id="prodi_id" class="form-control" value="{{ $lecturer->prodi->prodi_name }}" readonly>
            </div>
          ...
          <div class="mb-3" class="pl-5">
            <label for="email_dosen" class="form-label">Nama Dosen</label>
